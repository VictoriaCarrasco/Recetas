...
class Receta:
    ...
    def fecha_con_formato(self):
        return "Aqui le daremos formato a la fecha"
    ...
    def crear_uno(cls,data):
        ...
        return id_receta
# No es necesario un LEFT JOIN ya que todas las recetas van a tener de por sí su usuario.
    @classmethod
    ...
    def validar_formulario_recetas (data):
        ...
        if "menos_treinta" not in data:
            es_valido = False
            flash ("Debes proporcionar si la receta se elabora en menos de treinta minutos", "error_menos_treinta")
